#!/usr/bin/env node
// Manually trigger a Vercel deploy of citizenofnowhere.org.
//
// Usage:
//   VERCEL_DEPLOY_HOOK_URL="https://api.vercel.com/v1/integrations/deploy/..." \
//     npm run rebuild:trigger
//
// Or persist the hook URL in a local .env file (gitignored) and source it
// before running. The same URL the GitHub Action uses; see
...
// you publish a new Substack post and want it live in two minutes instead of
// the next morning, this is the one-liner.
